...
EthercatSlave* KVDetectorDriveMKLKTBuilder::Build(uint16_t alias, uint16_t position)
{
    ...
    ecat_drive->SetSlaveInfo(kKVDetectorDriveNameMKLKT, alias, position, 0x0000AAAA, 0x00000005);
